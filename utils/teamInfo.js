...
export function getTeamHealthBoost(team) {
    ...
    if(team.leader) totalHealthBoost += getSkillEffect(team.leader).healthBoost * 2
...
export function getTeamScoreBoost(team) {
    ...
    if(team.leader) teamScoreBoost += getSkillEffect(team.leader).scoreBoostPercentage * 2
